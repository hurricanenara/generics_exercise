...
import { createTupleTriplet, getCuisineOptions, getLength, getRoleOptions, strictCreateTupleTriplet } from './index';

describe('#createTupleTriplet', () => {
    it('returns the correct values', () => {
        expect(createTupleTriplet(1001, 'hello there', true)).toEqual([1001, 'hello there', true]);
    });
});

describe('#strictCreateTupleTriplet', () => {
    it('returns the correct values', () => {
        expect(strictCreateTupleTriplet(1001, true, [1001])).toEqual([1001, true, [1001]]);
    });
});
